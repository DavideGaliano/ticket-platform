...
--Tickets
INSERT INTO tickets (id, titolo, descrizione, data_creazione, stato, id_operatore) VALUES (1, 'Colpa di Allegri', 'La juve non segna', NOW(), 'DA_FARE', 2);
INSERT INTO tickets (id, titolo, descrizione, data_creazione, stato, id_operatore) VALUES (2, 'Pareggio Italia', 'Brutta partita contro il Belgio', NOW(), 'DA_FARE', 2);
INSERT INTO tickets (id, titolo, descrizione, data_creazione, stato, id_operatore) VALUES (3, 'Sconfitta Italia', 'Brutta partita contro il Belgio', NOW(), 'DA_FARE', 3);
